...
class XeggexApi implements PriceFeed {
    ...
    public urlHist: string = 'https://api.xeggex.com/api/v2/market/candles?symbol=EAC%2FUSDT&from={TIMESTAMP1}&to={TIMESTAMP2}&resolution={GRANULARITY}&countBack=120';
