    ...
    .pipe(
      ...
      map((assetsMinimal) => {
        if (this.stateService.network === 'liquidtestnet') {
          ...
          assetsMinimal['144c654344aa716d6f3abcc1ca90e5641e4e2a7f633bc09fe3baf64585819a49'] = [null, "tL-EAC", "Test Liquid Earthcoin", 8];
        }
