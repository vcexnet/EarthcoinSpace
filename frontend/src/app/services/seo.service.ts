...
export class SeoService {
  network = '';
  baseTitle = 'Earthcoin';
  baseDescription = 'Explore the full Earthcoin ecosystem&reg; with The Mempool Open Source Project&reg;.';
  baseDomain = 'earthcoin.space';
  ...
  getTitle(): string {
    if (this.network === 'testnet')
      return this.baseTitle + ' - Earthcoin Testnet3';
    if (this.network === 'testnet4')
      return this.baseTitle + ' - Earthcoin Testnet4';
    if (this.network === 'signet')
      return this.baseTitle + ' - Earthcoin Signet';
    if (this.network === 'liquid')
      return this.baseTitle + ' - Liquid Network';
    if (this.network === 'liquidtestnet')
      return this.baseTitle + ' - Liquid Testnet';
    return this.baseTitle + ' - ' + (this.network ? this.ucfirst(this.network) : 'Earthcoin') + ' Explorer';
  }
